...
namespace Soenneker.Cursor.CloudAgents.OpenApiClient.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// <summary>GitHub pull request URL. When provided, the agent works on this PR&apos;s repository and branches; `url` and `startingRef` are ignored.</summary>
...
#nullable restore
        ...
        public string PrUrl { get; set; }
#endif
        /// <summary>Branch, tag, or commit hash to use as the starting point.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string StartingRef { get; set; }
#endif
        /// <summary>GitHub repository URL. Required unless `prUrl` is provided.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
